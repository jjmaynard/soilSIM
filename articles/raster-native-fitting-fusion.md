...
#> 2 / 598 cells (0%) have an infeasible metalog fit
...
means
#>                          source    value
#> 1         Prior (SSURGO median) 16.85105
#> 2 Likelihood (SOLUS prediction) 20.83220
#> 3        Posterior (fused mean) 17.91583
```
...
#> 1     Prior (SSURGO)   2.603665    0.147512829
#> 2 Likelihood (SOLUS)  12.541739    0.006357473
```
...
tug-of-war), a 5x wider sigma means roughly a 23x lower precision - so
the posterior mean above (17.92) landing close to the prior’s mean
(16.85) rather than the likelihood’s (20.83) is the fusion math doing
...
#> 1  Pixel 1 (mapunit-like cluster, prior P50 ~1.8%)  1.796327    3.078828     18
#> 2 Pixel 2 (mapunit-like cluster, prior P50 ~14.2%) 14.201491    1.333701     19
#> 3 Pixel 3 (mapunit-like cluster, prior P50 ~14.2%) 14.201491    1.333701     19
#> 4 Pixel 4 (mapunit-like cluster, prior P50 ~28.7%) 28.664738    2.804251     26
#>   lik_sigma   post_mu post_sigma
#> 1  12.75534  3.694613   3.340083
#> 2  12.24512 14.297578   1.294392
#> 3  12.24512 14.297578   1.294392
#> 4  14.03087 28.858133   2.953765
```
