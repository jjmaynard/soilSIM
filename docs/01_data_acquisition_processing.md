...
**Purpose**: Builds the property-name lookup table mapping the 9 default SSURGO property base names to their `_l`/`_r`/`_h` SSURGO column names.

**Parameters**: None.

**Returns**: A data frame with columns `Property`, `SSURGO_Label_Low`, `SSURGO_Label_Rep`, `SSURGO_Label_High`, one row per of the 9 known properties (`sandtotal`, `claytotal`, `silttotal`, `dbovendry`, `ph1to1h2o`, `cec7`, `om`, `wthirdbar`, `wfifteenbar`).
