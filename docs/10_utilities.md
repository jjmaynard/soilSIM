...
- `strict_mode` - Whether to apply additional strict-mode criteria (default `TRUE`; note this differs from an earlier version of this function, which defaulted to `FALSE`).
