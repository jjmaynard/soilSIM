...
- **`get_default_configuration()`** - `R/core-gp.R`, `R/core-gp.R` (multiple call sites), `R/adapter-ssurgo-acquire.R` (two call sites), `R/statistics.R`, `R/diagnostics.R` (multiple call sites), `R/core-montecarlo.R`.
