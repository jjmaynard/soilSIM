...
- **Get Started**:
  ...
  data. Three more vignettes cover profile/depth simulation, available
  water storage via Van Genuchten/ROSETTA, and multi-source raster
  fusion (SSURGO x SOLUS100).
