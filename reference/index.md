...
Available water storage via ROSETTA pedotransfer parameters.
...
- [`align_percentile_probs()`](https://jjmaynard.github.io/soilSIM/reference/align_percentile_probs.md)
  ...
  probability grid when they differ (e.g. one source's 5th/95th
  percentiles vs another's 2.5th/97.5th) - every fusion route below fits
...
Non-exported helpers, internal file-grouping doc anchors, and constants
that are documented (so they have their own help page) but not part of
soilSIM’s public API. Not part of the Get Started path - only relevant
if you’re reading soilSIM’s source.
...
- [`.kssl_texture_matrices()`](https://jjmaynard.github.io/soilSIM/reference/dot-kssl_texture_matrices.md)
  : KSSL texture (sand/silt/clay) correlation matrices (internal
  accessor)
...
- [`as_lrh_triplet()`](https://jjmaynard.github.io/soilSIM/reference/as_lrh_triplet.md)
  ...
  Reduce an `observed_data` entry to an unnamed `c(low, rep, high)`
  triplet
...
- [`aws_simulation`](https://jjmaynard.github.io/soilSIM/reference/aws_simulation.md)
  : Van Genuchten / ROSETTA-Based Available Water Storage (AWS) Modeling

- [`bayesian_updating`](https://jjmaynard.github.io/soilSIM/reference/bayesian_updating.md)
...
- [`calculate_depth_weighted_mean()`](https://jjmaynard.github.io/soilSIM/reference/calculate_depth_weighted_mean.md)
...
- [`calculate_horizon_similarity()`](https://jjmaynard.github.io/soilSIM/reference/calculate_horizon_similarity.md)
...
- [`depth_simulation`](https://jjmaynard.github.io/soilSIM/reference/depth_simulation.md)
...
- [`distribution_fitting_raster`](https://jjmaynard.github.io/soilSIM/reference/distribution_fitting_raster.md)
  : Raster-Native Percentile-Based Distribution Fitting

- [`distributions`](https://jjmaynard.github.io/soilSIM/reference/distributions.md)
  : Percentile-Triplet Distribution Fitting, ILR Composition Utilities,
  and Matrix Utilities
...
- [`extract_percentile_pairs()`](https://jjmaynard.github.io/soilSIM/reference/extract_percentile_pairs.md)
  : Parse percentile columns (e.g. "P0","P5","P50") from a one-row data
  frame

- [`fetch_osd_horizons_cached()`](https://jjmaynard.github.io/soilSIM/reference/fetch_osd_horizons_cached.md)
  : Fetch OSD horizon distinctness data for a set of soil series names,
  with per-series caching
...
- [`fuse_closed_form()`](https://jjmaynard.github.io/soilSIM/reference/fuse_closed_form.md)
  ...
  [`fuse_adaptive()`](https://jjmaynard.github.io/soilSIM/reference/fuse_adaptive.md),
  with a per-cell fallback to Normal-moment fusion (re-expressed back
  into the requested family) where the naive same-family fusion is
  infeasible.
...
- [`get_sum_constraints()`](https://jjmaynard.github.io/soilSIM/reference/get_sum_constraints.md)
  : Determine sum-to-100 constraints (e.g. texture) to apply
  post-simulation

- [`gp_modeling`](https://jjmaynard.github.io/soilSIM/reference/gp_modeling.md)
  : Gaussian Process Depth Modeling
...
- [`kssl_reference_correlations`](https://jjmaynard.github.io/soilSIM/reference/kssl_reference_correlations.md)
...
- [`monte_carlo_simulation`](https://jjmaynard.github.io/soilSIM/reference/monte_carlo_simulation.md)
  : Monte Carlo Simulation Engine

- [`multivariate_adjustment`](https://jjmaynard.github.io/soilSIM/reference/multivariate_adjustment.md)
  : Multivariate Adjustment & GP Integration

- [`optimize_gp_hyperparameters()`](https://jjmaynard.github.io/soilSIM/reference/optimize_gp_hyperparameters.md)
  : Optimize GP Hyperparameters

- [`parallel_utils`](https://jjmaynard.github.io/soilSIM/reference/parallel_utils.md)
  :

  Shared `future`/`future.apply` Parallel Dispatch Helper

- [`parse_single_string_advanced()`](https://jjmaynard.github.io/soilSIM/reference/parse_single_string_advanced.md)
  : Parse Single String Advanced

- [`percentile_index()`](https://jjmaynard.github.io/soilSIM/reference/percentile_index.md)
  : Locate the low/median/high indices and probabilities within a
  percentile probability vector.

- [`percentile_interior()`](https://jjmaynard.github.io/soilSIM/reference/percentile_interior.md)
  :
...
- [`percentile_sampling`](https://jjmaynard.github.io/soilSIM/reference/percentile_sampling.md)
...
- [`property_simulation`](https://jjmaynard.github.io/soilSIM/reference/property_simulation.md)
...
- [`raster_digamma()`](https://jjmaynard.github.io/soilSIM/reference/raster_digamma.md)
  :

  [`fitdistrplus::fitdist()`](https://lbbe-software.github.io/fitdistrplus/reference/fitdist.html)'s
  generic [`optim()`](https://rdrr.io/r/stats/optim.html)-based MLE has
  no vectorized form. The Beta log-likelihood's score/Hessian equations
  have a known closed form in terms of
...
- [`raster_fusion`](https://jjmaynard.github.io/soilSIM/reference/raster_fusion.md)
...
- [`run_parallel_lapply()`](https://jjmaynard.github.io/soilSIM/reference/run_parallel_lapply.md)
  ...
  Run a Function Over a List/Vector, in Parallel via `future.apply`,
...
- [`select_simulation_correlation_matrix()`](https://jjmaynard.github.io/soilSIM/reference/select_simulation_correlation_matrix.md)
  : Select a Correlation Matrix and Property Set for Single-Cokey
  Simulation

- [`set_verbose_logging()`](https://jjmaynard.github.io/soilSIM/reference/set_verbose_logging.md)
  : Temporarily raise the package's log verbosity for the duration of a
  call

- [`sim_beta()`](https://jjmaynard.github.io/soilSIM/reference/sim_beta.md)
  : Beta distribution sampler (fits a Beta distribution to percentiles
  rescaled to the unit interval)

- [`sim_kde()`](https://jjmaynard.github.io/soilSIM/reference/sim_kde.md)
  : KDE sampler: seeds truncated-normal draws around each percentile,
  then resamples from their kernel density estimate

- [`sim_linear_cdf()`](https://jjmaynard.github.io/soilSIM/reference/sim_linear_cdf.md)
  : Piecewise-linear inverse-CDF sampler (nonparametric, exact at knots,
  clamped tails)

- [`sim_normal()`](https://jjmaynard.github.io/soilSIM/reference/sim_normal.md)
  : Normal distribution sampler (P50 as mean; SD from the widest
  available percentile pair)

- [`sim_spline()`](https://jjmaynard.github.io/soilSIM/reference/sim_spline.md)
  : Monotonic-spline inverse-CDF sampler (smoother than linear, still
  exact at knots)

- [`soil_infilling`](https://jjmaynard.github.io/soilSIM/reference/soil_infilling.md)
  : Soil Property Infilling System

- [`soil_statistics`](https://jjmaynard.github.io/soilSIM/reference/soil_statistics.md)
  : Statistical Analysis & Correlation Modeling

- [`soilSIM`](https://jjmaynard.github.io/soilSIM/reference/soilSIM-package.md)
  [`soilSIM-package`](https://jjmaynard.github.io/soilSIM/reference/soilSIM-package.md)
  : soilSIM: Multi-Source Soil Property Simulation and Bayesian Data
  Fusion

- [`solus_simulation`](https://jjmaynard.github.io/soilSIM/reference/solus_simulation.md)
  : Raster SOLUS Percentile Likelihood

- [`ssurgo_data`](https://jjmaynard.github.io/soilSIM/reference/ssurgo_data.md)
  : SSURGO Data Acquisition & Management

- [`ssurgo_processing`](https://jjmaynard.github.io/soilSIM/reference/ssurgo_processing.md)
  : SSURGO Data Processing & Standardization

- [`ssurgo_simulation`](https://jjmaynard.github.io/soilSIM/reference/ssurgo_simulation.md)
...
- [`validation_diagnostics`](https://jjmaynard.github.io/soilSIM/reference/validation_diagnostics.md)
...
- [`wrap_percentile_list()`](https://jjmaynard.github.io/soilSIM/reference/wrap_percentile_list.md)
  ...
  `list(values = <list of SpatRaster>, probs = )` percentile structure
  for caching - see
