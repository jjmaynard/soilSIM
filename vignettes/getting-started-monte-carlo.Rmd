...
see the "Where this data came from" note below. See `soilSIM/docs/01_data_acquisition_processing.md`,
`03_distribution_fitting_correlations.md`, `04_monte_carlo_simulation.md`, and
`05_gp_modeling_multivariate_adjustment.md` for the full function-level reference behind each step.
...
From here,
`integrate_monte_carlo_with_gp()` (see `soilSIM/docs/05_gp_modeling_multivariate_adjustment.md`)
